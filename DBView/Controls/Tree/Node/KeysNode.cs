...
{
    public class KeysNode : AbstractDBNode
    {
        public KeysNode() : base("Keys", NodeType.TABLE_KEYS)
        {
        ...
        public override List<string> ProcessExpandSafely()
        {
            ...
            return dbViewProvider.RetreiveAllKeyColumnsForGivenTable(Parent.Text);
        }

        public override void FinishExpand(List<string> childNodeNames)
        {
            base.FinishExpand(childNodeNames);
            childNodeNames.ForEach(childNodeName => Nodes.Add(new KeyNode(childNodeName)));
        }
    }
}
